...
public final class sfm implements Module {//Standard fels module
    ...
    @Override
    public void init() {
        final MapValue map = new MapValue(55);

        Functions.set("echo",new Function(){
        ...
        Functions.set("const", new Function() {
            @Override
            public Value execute(Value[] args) {
        ...
        Functions.set("readln", new Function() {
            @Override
            public Value execute(Value[] args) {
        ...
        Functions.set("readNum", new Function() {
            @Override
            public Value execute(Value[] args) {
                Scanner scan = new Scanner(System.in);
        ...
        Functions.set("splice", new Function() {
            @Override
            public Value execute(Value[] args) {
        ...
        Functions.set("indexOf", new Function() {
            @Override
        ...
        Functions.set("lastIndexOf", new Function() {
            @Override
            public Value execute(Value[] args) {
        ...
        Functions.set("replace", new Function() {
            @Override
            public Value execute(Value[] f) {
                String value = f[0].asString();
        ...
        Functions.set("trim", new Function() {
            @Override
            public Value execute(Value[] f) {
                return new StringValue(f[0].asString().trim());
            }
        });
        Functions.set("getBytes", new Function() {
            @Override
            public Value execute(Value[] f) {
                String value = f[0].asString();
        ...
        Functions.set("split", new Function() {
            @Override
            public Value execute(Value[] args) {
        ...
        Functions.set("toHexString", new Function() {
            @Override
            public Value execute(Value[] args) {
        ...
        Functions.set("equals", new Function() {
            @Override
            public Value execute(Value[] f) {
        ...
        Functions.set("concat", new Function() {
            @Override
            public Value execute(Value[] f){
        ...
        Functions.set("equalsIgnoreCase", new Function() {
            @Override
            public Value execute(Value[] f) {
        ...
        Functions.set("quit", new Function() {
            @Override
            public Value execute(Value[] f) {
        ...
        Functions.set("replaceAll", new Function() {
            @Override
            public Value execute(Value[] f) {
        ...
        Functions.set("replaceFirst", new Function() {
            @Override
            public Value execute(Value[] f) {
                if (f.length != 3) throw new ArgumentsMismatchException("Three arguments expected");
        ...
        Functions.set("sprintf", new Function() {
            @Override
            public Value execute(Value[] args) {
        ...
        Functions.set("arrayCombine", new Function() {
            @Override
            public Value execute(Value[] args) {
        ...
        Functions.set("arrayKeyExists", new Function() {
            @Override
            public Value execute(Value[] args) {
                if (args.length != 2) throw new ArgumentsMismatchException("Two arguments expected");
        ...
        Functions.set("toChar", new Function() {
            @Override
            public Value execute(Value[] args) {
                Arguments.check(1, args.length);
        ...
        Functions.set("toCharArray", new Function() {
            @Override
            public Value execute(Value... args) {
        ...
        Functions.set("charAt", new Function() {
            @Override
            public Value execute(Value[] args) {
                Arguments.check(2, args.length);
                final String input = args[0].asString();
        ...
        Functions.set("try", new Function() {
            @Override
        ...
        Functions.set("getEmpty", new Function() {
            @Override
            public Value execute(Value... args){
        ...
        Variables.define("__VERSION__",new StringValue(Information.FELS_VERSION));
        Variables.define("__AUTHOR__",new StringValue(Information.FELS_AUTHOR));
        Variables.define("__LOADERVER__",new StringValue(Information.LOADER_VERSION));
        Variables.define("__DATE__",new StringValue(Information.DATE));
