package main.java.net.felsstudio.fels.Modules.fels.io.ffsh;
...
public final class ffsh implements Module {
    ...
    private static class fopen implements Function {
        ...
        public Value execute(Value[] args) {
            ...
            final File file = main.java.net.felsstudio.fels.Console.fileInstance(args[0].asString());
            try {
                if (args.length > 1) {
