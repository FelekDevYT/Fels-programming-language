...
class date : Module {
    ...
    //</editor-fold>
    private class date_newDate : Function {
    ...
    private class date_newFormat : Function {
        override fun execute(vararg args: Value): Value {
            if (args.size == 0) {
    ...
    private class date_parse : Function {
        override fun execute(vararg args: Value): Value {
    ...
    private class date_format : Function {
        override fun execute(vararg args: Value): Value {
            Arguments.checkOrOr(1, 2, args.size)
    ...
    private class date_toTimestamp : Function {
        override fun execute(vararg args: Value): Value {
